...
class CreditCurveSpec(object):
    ...
    def HelperConventions(self):
        ...
        if o != 0:
            ...
            from quantra_common.engine_client._generated.quantra.CdsHelperConventions import CdsHelperConventions
    ...
    def Quotes(self, j):
        ...
        if o != 0:
            ...
            from quantra_common.engine_client._generated.quantra.CdsQuote import CdsQuote
            obj = CdsQuote()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
class CreditCurveSpecT(object):
    ...
    def _UnPack(self, creditCurveSpec):
        from quantra_common.engine_client._generated.quantra.CdsHelperConventions import CdsHelperConventionsT
