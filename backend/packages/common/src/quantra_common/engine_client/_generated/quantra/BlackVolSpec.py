...
class BlackVolSpec(object):
    ...
    def Base(self):
        ...
        if o != 0:
            ...
            from quantra_common.engine_client._generated.quantra.BlackVolBaseSpec import BlackVolBaseSpec
...
class BlackVolSpecT(object):
    ...
    def _UnPack(self, blackVolSpec):
        from quantra_common.engine_client._generated.quantra.BlackVolBaseSpec import BlackVolBaseSpecT
        from quantra_common.engine_client._generated.quantra.Period import PeriodT
        from quantra_common.engine_client._generated.quantra.QuoteMatrix2D import QuoteMatrix2DT
