...
class BlackIborCouponPricer(object):
    ...
    def OptionletVolatility(self):
        ...
        if o != 0:
            ...
            from quantra_common.engine_client._generated.quantra.ConstantOptionletVolatility import ConstantOptionletVolatility
...
class BlackIborCouponPricerT(object):
    ...
    def _UnPack(self, blackIborCouponPricer):
        from quantra_common.engine_client._generated.quantra.ConstantOptionletVolatility import ConstantOptionletVolatilityT
