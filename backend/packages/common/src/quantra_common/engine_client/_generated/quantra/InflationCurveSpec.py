...
class InflationCurveSpec(object):
    ...
    def Points(self, j):
        ...
        if o != 0:
            ...
            from quantra_common.engine_client._generated.quantra.InflationPointWrapper import InflationPointWrapper
...
class InflationCurveSpecT(object):
    ...
    def _UnPack(self, inflationCurveSpec):
        from quantra_common.engine_client._generated.quantra.InflationPointWrapper import InflationPointWrapperT
