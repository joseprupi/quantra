...
class VanillaSwap(object):
    ...
    def FixedLeg(self):
        ...
        if o != 0:
            ...
            from quantra_common.engine_client._generated.quantra.SwapFixedLeg import SwapFixedLeg
            obj = SwapFixedLeg()
    ...
    def FloatingLeg(self):
        ...
        if o != 0:
            x = self._tab.Indirect(o + self._tab.Pos)
            from quantra_common.engine_client._generated.quantra.SwapFloatingLeg import SwapFloatingLeg
            obj = SwapFloatingLeg()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def CmsLeg(self):
        ...
        if o != 0:
            x = self._tab.Indirect(o + self._tab.Pos)
            from quantra_common.engine_client._generated.quantra.SwapCmsLeg import SwapCmsLeg
            obj = SwapCmsLeg()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
