...
class PriceFloatingRateBondResponse(object):
    ...
    def Bonds(self, j):
        ...
        if o != 0:
            ...
            from quantra_common.engine_client._generated.quantra.FloatingRateBondResponse import FloatingRateBondResponse
...
class PriceFloatingRateBondResponseT(object):
    ...
    def _UnPack(self, priceFloatingRateBondResponse):
        from quantra_common.engine_client._generated.quantra.FloatingRateBondResponse import FloatingRateBondResponseT
