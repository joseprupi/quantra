...
class PriceSwaptionRequest(object):
    ...
    def Swaptions(self, j):
        ...
        if o != 0:
            ...
            from quantra_common.engine_client._generated.quantra.PriceSwaption import PriceSwaption
            obj = PriceSwaption()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
class PriceSwaptionRequestT(object):
    ...
    def _UnPack(self, priceSwaptionRequest):
        from quantra_common.engine_client._generated.quantra.PriceSwaption import PriceSwaptionT
