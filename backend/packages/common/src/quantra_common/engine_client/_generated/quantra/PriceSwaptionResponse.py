...
class PriceSwaptionResponse(object):
    ...
    def Swaptions(self, j):
        ...
        if o != 0:
            ...
            from quantra_common.engine_client._generated.quantra.SwaptionResponse import SwaptionResponse
    ...
    def Diagnostics(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from quantra_common.engine_client._generated.quantra.SwaptionVolDiagnostics import SwaptionVolDiagnostics
...
class PriceSwaptionResponseT(object):
    ...
    def _UnPack(self, priceSwaptionResponse):
        from quantra_common.engine_client._generated.quantra.SwaptionResponse import SwaptionResponseT
        from quantra_common.engine_client._generated.quantra.SwaptionVolDiagnostics import SwaptionVolDiagnosticsT
