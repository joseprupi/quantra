...
engine 0.2.0. These four modules are byte-exact copies of the pre-regen
(0.2.0-layout) generated bindings; ``wire_compat`` selects between them and
the canonical ``_generated`` set via ``ENGINE_WIRE_COMPAT``.
